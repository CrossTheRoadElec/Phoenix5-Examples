...
public class Robot extends IterativeRobot {
	...
	public void teleopInit(){
		...
		/* Configure Allowable Error on Closed Loop */
		_rightMaster.configAllowableClosedloopError(Constants.kSlot_Turning, 2, Constants.kTimeoutMs);	//Keep within 2 degrees
	...
	/* Zero all sensors used in Auxiliary Examples */
	void zeroSensors() {
