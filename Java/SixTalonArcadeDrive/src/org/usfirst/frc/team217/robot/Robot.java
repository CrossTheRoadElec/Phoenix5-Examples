...
public class Robot extends IterativeRobot {
	...
	WPI_TalonSRX _frontLeftMotor = new WPI_TalonSRX(
			11); /* device IDs here (1 of 2) */
	...
	public void teleopPeriodic() {
		double forward = _joy.getY(); // logitech gampad left X, positive is
										// forward
		double turn = _joy.getZ(); // logitech gampad right X, positive means
									// turn right
