...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		 ...
		 * position
		 */
		int absolutePosition = _talon
				.getSelectedSensorPosition(Constants.kTimeoutMs)
				& 0xFFF; /*
	...
	public void teleopPeriodic() {
		...
		if (!_lastButton1 && button1) {
			...
			targetPositionRotations = leftYstick * 50.0
					* 4096; /* 50 Rotations * 4096 u/rev in either direction */
			_talon.set(ControlMode.Position,
					targetPositionRotations); /*
												 * 50 rotations in either
												 * direction
												 */
