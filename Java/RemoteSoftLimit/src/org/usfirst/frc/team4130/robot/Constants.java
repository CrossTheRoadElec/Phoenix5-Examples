...
public class Constants {
	...
	public final static int kNumButtonsPlusOne = 10; /* 10 means buttons[1,9] are polled, which is actually 10 buttons */
	...
	public final static int kReverseSoftLimit_PWMInput = -3000; /* 4096 => 100% dutyCycle, negative or negative depending on phase. */
}
