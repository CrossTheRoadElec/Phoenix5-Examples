...
public class Robot extends TimedRobot {
    ...
    /* pick one of these */
    TalonSRX _pigeonTalon = new TalonSRX(2); /* Pigeon is ribbon cabled to this Talon */
    // TalonSRX _pigeonTalon = null; /* Pigeon is on CAN bus, so there is no Talon
    ...
    /**
     * Which filter to use in Talon to capture Pigeon (0 or 1). If you are not using
     * Pigeon in your drietrain closed-loop, this doesn't matter.
     */
    ...
    boolean _printEnable = false; //!< True => print signal values periodically
    ...
    /**
     * helper routine to track if pigeon is on CAN or ribbon cable, this influces
    ...
    public void robotPeriodic() {
        ...
        /* button 1 and 3 will change which Pigeon axis to instrument */
        if (_joy.getRawButtonPressed(1) || _joy.getRawButtonPressed(3)) {
            if (_joy.getRawButton(1))
                _axisSelection--;
            else
                _axisSelection++;
            /* some clever math to wrap 2=>0, and 0=>2 */
        ...
        if (_joy.getRawButtonPressed(5) || _joy.getRawButtonPressed(6)) {
            ...
            /* some clever math to wrap 8=>0, and 8=>2 */
    ...
    public void teleopPeriodic() {
        ...
        if (_rghtSide == null) {
            ...
            /* drive the drivetrain assuming a simple diff drive */
