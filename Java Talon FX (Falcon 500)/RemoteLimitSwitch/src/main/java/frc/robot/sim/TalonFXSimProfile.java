...
class TalonFXSimProfile extends SimProfile {
    ...
    public void run() {
        ...
        _falcon.getSimCollection().setLimitFwd(_falcon.getSelectedSensorPosition() > 50000);
        _falcon.getSimCollection().setLimitRev(_falcon.getSelectedSensorPosition() < -50000);
    }
}