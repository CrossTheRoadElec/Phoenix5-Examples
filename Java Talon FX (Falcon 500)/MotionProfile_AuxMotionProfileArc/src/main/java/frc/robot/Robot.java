...
public class Robot extends TimedRobot {
	...
	public void teleopInit(){
		...
		_rightMaster.configRemoteFeedbackFilter(_leftMaster.getDeviceID(),
												...
												Constants.REMOTE_0);
		_rightMaster.configSelectedFeedbackSensor(TalonFXFeedbackDevice.RemoteSensor0,
												Constants.PID_PRIMARY,
												Constants.kTimeoutMs);
		...
		_rightMaster.configRemoteFeedbackFilter(_pidgey.getDeviceID(),
												...
												Constants.REMOTE_1,	
												Constants.kTimeoutMs);
		_rightMaster.configSelectedFeedbackSensor(TalonFXFeedbackDevice.RemoteSensor1,
												Constants.PID_TURN,
												Constants.kTimeoutMs);
