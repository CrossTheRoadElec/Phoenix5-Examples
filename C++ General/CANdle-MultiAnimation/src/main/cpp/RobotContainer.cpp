...
void RobotContainer::ConfigureButtonBindings() {
  ...
  frc2::JoystickButton(&m_joy, nextAnimID).OnTrue([this]{m_subsystem.IncrementAnimation();});
  ...
  frc2::POVButton(&m_joy, ChangeDirectionAngle).OnTrue([this]{m_subsystem.ToggleAnimDirection();});

  frc2::JoystickButton(&m_joy, 9).OnTrue([this]{m_subsystem.ClearAllAnims();});
  frc2::JoystickButton(&m_joy, 10).OnTrue([this]{m_subsystem.Toggle5VOverride();});
}
