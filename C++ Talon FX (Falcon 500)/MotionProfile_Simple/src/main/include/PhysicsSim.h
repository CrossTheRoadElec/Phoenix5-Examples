...
public:
     ...
     */
    void AddTalonFX(TalonFX &falcon, double const accelToFullTime, double const fullVel, bool const sensorPhase = false) {
        TalonFXSimProfile* simFalcon = new TalonFXSimProfile(falcon, accelToFullTime, fullVel, sensorPhase);
        this->_simProfiles.insert(this->_simProfiles.end(), simFalcon);
    }
...
private:
    ...
    public:
         ...
         *        The phase of the TalonFX sensors
         */
        TalonFXSimProfile(TalonFX &talon, double const accelToFullTime, double const fullVel, bool const sensorPhase = false)
            : _falcon(talon), _accelToFullTime(accelToFullTime), _fullVel(fullVel), _sensorPhase(sensorPhase) {}
