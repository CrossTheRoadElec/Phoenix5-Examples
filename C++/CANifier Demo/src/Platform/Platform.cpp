...
/* TaskList */
std::vector<ILoopable*> Tasks::FullList = { taskAnimateLEDStrip,
		taskDirectControlArm, taskPWMmotorController, taskMeasurePulseSensors,
		taskLIDARControlLEDStrip, taskHSVControlLedStrip, taskMainLoop, };
