...
namespace DriveStraightDistanceAuxiliary
{
    public class Program
    {
        public static void Main()
        {
            ...
            /** Feedback Sensor Configuration [Remote Difference & Sum] */
            ...
            Hardware._leftTalon.SetStatusFramePeriod(StatusFrameEnhanced.Status_2_Feedback0, 5, Constants.kTimeoutMs);      // Speed up frame due to usage by right Talon 
            ...
            while (true)
            {
                ...
                if (btns[2] && !_btns[2])
                {
                    ...
                    _lastDistance = Hardware._rightTalon.GetSelectedSensorPosition(0);
                }
                ...
                else
                {
                    if (_firstCall)
                    {
                        Debug.Print("This is Drive Straight Distance using the Auxiliary feature with the difference between two encoders.");
                    ...
                    double target_sensorUnits = forward * Constants.kSensorUnitsPerRotation * Constants.kRotationsToTravel + _lastDistance;
