...
using DriveStraightMotionMagicAuxiliary.Platform;
using CTRE.Phoenix.MotorControl;
using CTRE.Phoenix.Sensors;

namespace DriveStraightMotionMagicAuxiliary
{
    public class Program
    {
        public static void Main()
        {
            ...
            /** Feedback Sensor Configuration [Remote Sum and Difference] */
            ...
            while (true)
            {
                ...
                if (btns[2] && !_btns[2])
                {
                    ...
                    _lastPosition = Hardware._rightTalon.GetSelectedSensorPosition(0);
                }
                ...
                else
                {
                    if (_firstCall)
                    {
                        Debug.Print("This is Drive Straight Motion Magic using the Auxiliary feature with Quadrature Encoders.");
                    ...
                    double target_sensorUnits = forward * Constants.kSensorUnitsPerRotation * Constants.kRotationsToTravel + _lastPosition;
                    double target_turn = _targetAngle;

                    /* Configured for Motion Magic on Quad Encoders' Sum and Auxiliary PID on Quad Encoders' Difference */
                    Hardware._rightTalon.Set(ControlMode.MotionMagic, target_sensorUnits, DemandType.AuxPID, target_turn);
