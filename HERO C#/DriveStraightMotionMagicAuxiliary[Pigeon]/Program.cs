        ...
        public static void Main()
        {
            ...
            while (true)
            {
                ...
                else
                {
                    if (_firstCall)
                    {
                        Debug.Print("This is Drive Straight Motion Magic using the Auxiliary feature with a Pigeon IMU.");
                    ...
                    /* Configured for Motion Magic on Quad Encoders' Sum and Auxiliary PID on Pigeon's Yaw */
