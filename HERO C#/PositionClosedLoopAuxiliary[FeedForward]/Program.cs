...
using PositionClosedLoopAuxiliary.Platform;
using CTRE.Phoenix.MotorControl;
using CTRE.Phoenix.Sensors;

namespace PositionClosedLoopAuxiliary
{
        ...
        public static void Main()
        {
            ...
            while (true)
            {
                ...
                else
                {
                    if (_firstCall)
                    {
                        Debug.Print("This is Position Closed Loop with a custom Feed Forward.");
                        Debug.Print("Travel [-8, 8] rotations while having the ability to add a FeedForward (right stick).\n");
                        ZeroSensors();
                    ...
                    /* Configured for Position Closed Loop on Quad Encoders' Sum and Arbitrary FeedForward on right stick */
                    Hardware._rightTalon.Set(ControlMode.Position, target_sensorUnits, DemandType.ArbitraryFeedForward, feedFwdTerm);
