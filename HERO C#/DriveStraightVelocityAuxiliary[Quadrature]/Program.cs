        ...
        public static void Main()
        {
            ...
            while (true)
            {
                ...
                else
                {
                    if (_firstCall)
                    {
                        Debug.Print("This is Drive Straight Velocity using the Auxiliary feature with Quadrature Encoders.");
                        Debug.Print("Travel [-500, 500] RPM in either direction while also maintaining a straight heading.\n");
                        ZeroPosition();
